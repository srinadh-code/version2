...
function TriagePage() {
  ...
  return (
    ...
    <div>
      ...
      <PageHeader
        title="Triage"
        description="Quickly accept, hold, or reject candidates"
      />
      ...
      <Tabs defaultValue="all">
        ...
        <TabsList>
          ...
          <TabsTrigger value="Shortlisted">
            Shortlisted ({lists.Shortlisted.length})
          </TabsTrigger>
        ...
        <TabsContent value="Shortlisted">
          {renderList(lists.Shortlisted)}
        </TabsContent>

        <TabsContent value="Pending">
          {renderList(lists.Pending)}
        </TabsContent>

        <TabsContent value="Hold">
          {renderList(lists.Hold)}
        </TabsContent>

        <TabsContent value="Rejected">
          {renderList(lists.Rejected)}
        </TabsContent>
